...
class EditProduct extends StatefulWidget {
  ...
  final bool isDialog; // Add this new property

  const EditProduct({
    Key? key,
    required this.orderItem,
    required this.onQuantityUpdated,
    this.isDialog = false, // Default to false for the screen version
  }) : super(key: key);
...
class _EditProductState extends State<EditProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.isDialog) {
      ...
      // SCREEN LAYOUT: Use the original Row layout
      return Center(
        child: Card(
          elevation: 8,
          margin: EdgeInsets.only(top: 10),
          ...
          child: Container(
            ...
            height: MediaQuery
                .of(context)
                .size
                .height * 0.9, // Reduced from 0.9 to 0.85
            padding: const EdgeInsets.all(5.0),
            child: Row(
